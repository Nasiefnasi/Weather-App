...
// //
// //     final hourlyWeatherDetails = hourlyWeatherDetailsFromJson(jsonString);

// import 'dart:convert';

// HourlyWeatherDetails hourlyWeatherDetailsFromJson(String str) =>
//     HourlyWeatherDetails.fromJson(json.decode(str));

// // String hourlyWeatherDetailsToJson(HourlyWeatherDetails data) =>
...
HourlyWeatherDetails hourlyWeatherDetailsFromJson(String str) => HourlyWeatherDetails.fromJson(json.decode(str));

String hourlyWeatherDetailsToJson(HourlyWeatherDetails data) => json.encode(data.toJson());
...
class HourlyWeatherDetails {
    ...
    factory HourlyWeatherDetails.fromJson(Map<String, dynamic> json) => HourlyWeatherDetails(
        cod: json["cod"],
        message: json["message"],
        cnt: json["cnt"],
