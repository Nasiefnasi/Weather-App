        ...
        child: SingleChildScrollView(physics: BouncingScrollPhysics(),
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  RichText(
                    ...
                    TextSpan(
                      text: "37$degree",
                      style: TextStyle(
                          fontFamily: "poppins", color: Vx.gray900, fontSize: 64),
                    ),
                    TextSpan(
                      text: "Sunny",
                      style: TextStyle(
              ...
              ListView.builder(itemCount: 7, itemBuilder: (context, index) {var day = DateFormat("EEEE").format(DateTime.now().add(Duration(days: index + 1)));
                return Card(child: Container(padding: EdgeInsets.symmetric(horizontal: 8,vertical: 12),child: Row(children: ["$day".text.make()]),),);
              },)
            ],
          ),
        ),
